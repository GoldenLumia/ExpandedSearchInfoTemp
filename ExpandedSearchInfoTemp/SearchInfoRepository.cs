...
using ExpandedSearchInfoTemp.Sections;
using Nager.PublicSuffix;

namespace ExpandedSearchInfoTemp {
    public class ExpandedSearchInfoTemp {
        public string Info { get; }
        public List<ISearchInfoSection> Sections { get; }

        public ExpandedSearchInfoTemp(string info, List<ISearchInfoSection> sections) {
            this.Info = info;
    ...
    public class SearchInfoRepository : IDisposable {
        ...
        internal ConcurrentDictionary<uint, ExpandedSearchInfoTemp> SearchInfos { get; } = new();
        ...
        private async Task DownloadAndExtract(uint objectId, string info, IEnumerable<Uri> uris) {
            ...
            var client = new HttpClient(handler) {
                DefaultRequestHeaders = {
                    UserAgent = { new ProductInfoHeaderValue("ExpandedSearchInfoTemp", version) },
                },
            };
            ...
            this.SearchInfos[objectId] = new ExpandedSearchInfoTemp(info, sections);
        }
    }
}
